...
public class frmReviseClaimTagging extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					frmReviseClaimTagging frame = new frmReviseClaimTagging();
	...
	public frmReviseClaimTagging(String checkNumber, String payeeName, String checkDate, String checkAmt, String OR, String ClaimedBy, String ID, Date dateClaimed) throws ParseException {
		...
		txtORNo.setText(OR);
		txtClaimedBy.setText(ClaimedBy);
		txtIDPresented.setText(ID);
		
		dateChooser.setDate(dateClaimed);
	...
	private void initialize() {
		...
		btnSave.setBounds(49, 286, 73, 28);
		panel.add(btnSave);
		...
		btnClose.setBounds(212, 286, 73, 28);
		panel.add(btnClose);
		...
		JButton btnUntag = new JButton("Untag");
		btnUntag.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				
				try {

					int reply = JOptionPane.showConfirmDialog(null, "Are you sure you want to Untag this checknumber [" + txtCheckNumber.getText() + "]?","Please confirm",JOptionPane.YES_NO_OPTION);
					
					if (reply == JOptionPane.YES_OPTION)
					{
							String query = "update tblcheck set ORNo = ?,ClaimedBy = ?,ClaimedDate = ?,ClaimedStamp = ?,ClaimedID = ?,Status = 'For Release' where CheckNumber = ? and PayeeName = ? and CheckAmount = ?";
		...
		btnUntag.setMnemonic('S');
		btnUntag.setBounds(133, 286, 73, 28);
		panel.add(btnUntag);
